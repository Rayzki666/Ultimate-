...
export const STYLES = [
  { id: 'cinematic', example: './assets/styles/cinematic.jpg', exampleAlt: "Window-lit portrait with teal surroundings and a relaxed three-quarter pose.", poseNote: "Relaxed hands at waist height. Subject on a third, with directional window light.", name: 'Cinematic Portrait', mood: 'INTIMATE / SCULPTED',
  ...
  { id: 'golden', example: './assets/styles/golden.jpg', exampleAlt: "Warm meadow portrait with a softly lit face and golden hair light.", poseNote: "Relaxed hands below the shoulders. Keep the face lit and preserve the glow behind the hair.", name: 'Golden Glow', mood: 'WARM / LUMINOUS',
  ...
  { id: 'travel', example: './assets/styles/travel.jpg', exampleAlt: "Full-body hiker beside a broad alpine lake with mountains in the background.", poseNote: "Stand naturally with hands lowered and both feet visible. Leave room for the setting.", name: 'Travel Story', mood: 'EXPANSIVE / EXPLORING',
  ...
  { id: 'editorial', example: './assets/styles/editorial.jpg', exampleAlt: "Centered full-body portrait in a symmetrical stone doorway.", poseNote: "Stand centered, shoulders visible and hands lowered. Include both feet.", name: 'Editorial', mood: 'PRECISE / CONFIDENT',
