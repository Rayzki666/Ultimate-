...
export const STYLES = [
  { id: 'cinematic', name: 'Cinematic Portrait', mood: 'INTIMATE / SCULPTED',
  ...
  { id: 'golden', name: 'Golden Glow', mood: 'WARM / LUMINOUS',
  ...
  { id: 'travel', name: 'Travel Story', mood: 'EXPANSIVE / EXPLORING',
  ...
  { id: 'editorial', name: 'Editorial', mood: 'PRECISE / CONFIDENT',
